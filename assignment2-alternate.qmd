...
covid_income_0406
```
- Counties with below-average median household income reported higher CLI on 2020-04-06 (about +0.093 in the mean and  +0.134 in the median). Since the it is descriptive and unweighted, it does not prove any casuality.
...
## Join: keep only counties present in both
...
```
-   Counties with below-average median household income reported higher CLI on 2020-04-06 (about +0.907 in the mean and +0.782 in the median). Since the it is descriptive and unweighted, it does not prove any casuality.
